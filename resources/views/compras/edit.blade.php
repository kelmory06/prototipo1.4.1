    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-body">
				...
				@endif
				{!! Form::model($compra, array('route' => array('compras.update', $compra->idCompra), 'method' => 'PUT')) !!}
				<div class="form-group">
					{!! Form::label('idCompra','numero factura') !!}
					{!! Form::number('idCompra', $compra->idCompra, ['class' => 'form-control']) !!}
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					{!! Form::label('valorTotalCompra','Valor de la Compra (con IVA)') !!}
					{!! Form::number('valorTotalCompra', null, array('class' => 'form-control')) !!}
				</div>
				<div class="form-group">
